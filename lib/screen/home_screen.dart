...
import 'package:ai_talk_app/component/chat_text_field.dart';
import 'package:ai_talk_app/component/date_divider.dart';
import 'package:ai_talk_app/component/logo.dart';
import 'package:ai_talk_app/component/message.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  handleSendMessage() async {
    ...
    try {
      ...
      final myMessagesCount = await isar.messageModels
          .filter()
          .isMineEqualTo(true)
          .count();
